...
const CourseNode = memo(({ data }: CourseNodeProps) => {
	...
	return (
		<div
			className={`border-2 border-black bg-white p-2 rounded w-40 h-40 flex flex-col justify-between hover:cursor-move`}
		>
			<Handle
				type="target"
			...
			<div className="flex justify-center items-center">
				<div
					className={`relative bg-${data.color} h-4 w-full text-center text-xs rounded`}
				>
